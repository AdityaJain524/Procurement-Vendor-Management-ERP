...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Enterprise procurement & vendor management platform. RFQs, quotations, approvals, POs, invoices and AI-powered analytics." },
      { property: "og:title", content: "VendorBridge — Procurement & Vendor Management ERP" },
      { property: "og:description", content: "Run your end-to-end procurement: vendors, RFQs, approvals, POs, invoices, and AI insights." },
